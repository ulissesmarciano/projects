...
const Greetings = ({toRepo, toStarred, toFollowing, toFollowers, name, repoNum, starredNum, followersNum, followingNum, resume}:IGreetings) => {
  return (
    <Container>
        <GreetingContainer>
