...
const Greetings = ({toRepo, toStarred, toFollowing, toFollowers, name}) => {
  return (
    <Container>
        <GreetingContainer>
        ...
        <InfoDataContainer>
          ...
          <InfoContainer>
            ...
            <ItemCountContainer>
              ...
              <Link to={toStarred}><p>1.4k</p></Link>
            </ItemCountContainer>
          </InfoContainer>
          <InfoContainer>
            <h4>Seguidores</h4>
            <ItemCountContainer>
              ...
              <Link to={toFollowers}><p>1.1k</p></Link>
            </ItemCountContainer>
          </InfoContainer>
          <InfoContainer>
            <h4>Seguindo</h4>
            <ItemCountContainer>
              ...
              <Link to={toFollowing}><p>216</p></Link>
            </ItemCountContainer>
          </InfoContainer>
        </InfoDataContainer>
      </Container>
